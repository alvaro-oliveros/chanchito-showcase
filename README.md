...
Confirmar el formato real de las alertas de compra de BofA para el importador de Gmail (deliberadamente sin implementar hasta tener un correo real de ejemplo, en vez de adivinar el formato), y ampliar cobertura de bancos soportados en los importadores automáticos.
